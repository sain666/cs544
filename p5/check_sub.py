...
def main():
    ...
    repo_url = "https://git.doit.wisc.edu/cdis/cs/courses/cs544/f24/main/-/raw/main/p5/"
    files = [
        "autograde.py",
    ]
    for file in files:
    ...
    # check for files
    required_files = ["boss.Dockerfile", "worker.Dockerfile", "nb/p5.ipynb"]
    ...
    # Run auto-grade
    subprocess.run(["python3", "-u", "autograde.py", "-v", "-k"])
